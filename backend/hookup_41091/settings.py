"""
Django settings for hookup_41091 project.
...
ROOT_URLCONF = 'hookup_41091.urls'
...
WSGI_APPLICATION = 'hookup_41091.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hookup_41091 API",
    "DESCRIPTION": "API documentation for hookup_41091 App",
    "VERSION": "v1",
}
